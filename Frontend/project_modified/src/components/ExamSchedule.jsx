        ...
        !items[0]?.semester ? ("") : (
          <div key={index} style={{ marginBottom: '28px' }}>
            <div className="svec-section-title">
              <div className="svec-form-panel-title">{items[0]?.semester} Semester &nbsp;<span style={{ color: 'var(--text-secondary)', fontWeight: 600, letterSpacing: '0.04em', textTransform: 'none', fontSize: '0.7rem' }}>({exam})</span></div>
            </div>
