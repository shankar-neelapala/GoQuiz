          ...
          <form onSubmit={updateschedule}>
            <div className="svec-table-wrap">
              <table className="svec-table">
                ...
                <tbody>
                  <tr>
                    <td style={{ color: 'var(--text-muted)', fontWeight: 600 }}>1</td>
                    ...
                    <td><input type='date' style={inputStyle} value={formatDateToInput(date)} onChange={(e) => setDate(formatDateToInput(e.target.value))} /></td>
                    <td><input type='time' style={inputStyle} value={formatTimeToInput(starttime)} onChange={(e) => setStarttime(formatTimeToInput(e.target.value))} /></td>
                    <td><input type='time' style={inputStyle} value={formatTimeToInput(endtime)} onChange={(e) => setEndtime(formatTimeToInput(e.target.value))} /></td>
